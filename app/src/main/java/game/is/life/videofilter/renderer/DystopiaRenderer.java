...
public class DystopiaRenderer extends CameraRenderer {

    public DystopiaRenderer(Context context, SurfaceTexture previewSurface, int width, int height)
    {
        super(context, previewSurface, width, height, "dystopia.frag.glsl", "base.vert.glsl");
